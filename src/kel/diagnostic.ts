...
export class Diagnostic {
    ...
    private constructor(ctx: vscode.ExtensionContext) {
        this._ctx = ctx;
        kelDiagnosticCollection = vscode.languages.createDiagnosticCollection("kel");
        ctx.subscriptions.push(kelDiagnosticCollection);
        kelQuickDiagnosticCollection = vscode.languages.createDiagnosticCollection("kelQuick");
